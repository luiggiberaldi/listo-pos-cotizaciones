-- 153_fix_reportes_cliente_despacho.sql
-- Modifica obtener_reporte_ventas_operaciones y obtener_reporte_ventas_comisiones
-- para hacer JOIN sobre notas_despacho.cliente_id en lugar de cotizaciones.cliente_id.
-- Esto garantiza que cualquier cambio de cliente realizado en administración sobre la
-- nota de despacho se refleje inmediatamente en todos los reportes y PDFs.
