-- 275_revertir_movimiento_inventario.sql
-- Release 15 — RPC de reversión de movimientos manuales de Kardex (PRINCIPAL).
-- Idéntica en cuerpo a 275_staging_revertir_movimiento_inventario.sql.
...
BEGIN
  ...
  -- Guard de idempotencia PRIMERO: un reintento de red con la misma clave
  -- devuelve el resultado cacheado aunque el actor haya cambiado.
