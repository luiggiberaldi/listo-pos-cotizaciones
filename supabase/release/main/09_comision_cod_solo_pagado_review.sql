-- ═══════════════════════════════════════════════════════════════════════════
-- RELEASE 09 (principal): Comisión solo cuando el COD está pagado (v4)
-- ═══════════════════════════════════════════════════════════════════════════
-- Espejo de 270_staging_comision_cod_solo_pagado.sql. Regla todo-o-nada:
-- despacho con porción "Cobro a destino" (monto>0) y cobro_destino_pagado ≠
-- true → CERO comisión (incluye la parte de adelanto en pagos mixtos). Al
-- conciliar el COD la comisión nace completa (disparador en Worker editar-pago).
-- Toggle por cuenta comision_cod_solo_pagado (default OFF).
-- Fuente del cuerpo: pg_get_functiondef del PRINCIPAL (validado con split v3.1).
-- ═══════════════════════════════════════════════════════════════════════════
...
-- calcularcomisiondespacho_238b con tranca COD:
