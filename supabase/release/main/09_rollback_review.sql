-- ═══════════════════════════════════════════════════════════════════════════
-- ROLLBACK 09 (principal): restaurar 238b al cuerpo previo (release 07/08b)
-- ═══════════════════════════════════════════════════════════════════════════
-- La columna comision_cod_solo_pagado se CONSERVA (inocua con toggle OFF y sin
-- tranca). El helper puede quedar (no es referenciado tras el rollback).
-- ═══════════════════════════════════════════════════════════════════════════
