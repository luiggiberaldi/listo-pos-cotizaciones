-- ═════════════════════════════════════════════════════════════════════════════
-- 08b_advertir_no_bloquear_review.sql
-- v2 "advertir, no bloquear" de la RPC de aprobación (release 08).
-- Espejo de la migración staging 269 (E2E 123/123 + arnés 20/20).
-- El stock insuficiente NUNCA rechaza: viene como 'faltantes' en la respuesta.
-- Nuevo p_solo_validar (solo lectura) para el pre-check del modal de la UI.
-- ═════════════════════════════════════════════════════════════════════════════
