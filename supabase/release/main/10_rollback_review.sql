-- Release 10 — ROLLBACK: restaura el cuerpo legacy de calcularcomisiondespacho
-- (estado vivo en main pre-release 10, dump 2026-09-07). ADVERTENCIA: el legacy
-- no tiene tranca COD ni split de sábados; solo usar si el delegador causa un
-- problema imprevisto.
