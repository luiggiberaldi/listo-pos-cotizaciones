...
// Supabase usa esta clave para persistir la sesión. Calcularla desde la URL
// evita confundir una sesión de otro proyecto (por ejemplo, staging) con la
// sesión del proyecto configurado para esta aplicación.
