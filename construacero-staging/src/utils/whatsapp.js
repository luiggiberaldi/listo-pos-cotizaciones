 ...
 */
export function generarMensaje({ nombreNegocio, nombreCliente, numDisplay, totalUsd, nombreVendedor, items = [], tipo = 'cotización', pdfUrl = null }) {
  ...
  const documento = pdfUrl
    ? `Pulse acá para descargar el documento PDF:\n${pdfUrl}`
