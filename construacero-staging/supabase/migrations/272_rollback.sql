-- 272_rollback.sql: restaura los cuerpos originales (pre-272).
-- Solo usar si 272 introduce un problema no previsto.
-- Fuente: dumps pg_get_functiondef previos a la aplicacion (2026-09-09).
