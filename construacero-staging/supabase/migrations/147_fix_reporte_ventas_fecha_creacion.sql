-- 147_fix_reporte_ventas_fecha_creacion.sql
-- Modifica los RPCs obtener_reporte_ventas_operaciones y obtener_reporte_ventas_comisiones
-- para filtrar, ordenar y reportar usando la fecha de creación (creado_en)
-- en lugar de coalescer con entregada_en.

-- ══════════════════════════════════════════════════════════════════════
-- 1. Actualizar obtener_reporte_ventas_operaciones
-- ══════════════════════════════════════════════════════════════════════
