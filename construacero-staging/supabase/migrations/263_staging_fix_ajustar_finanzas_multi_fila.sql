-- 263_staging_fix_ajustar_finanzas_multi_fila.sql
-- FIX de regresión introducido por 262: su redefinición de
-- ajustar_finanzas_devolucion_atomica escalaba solo UNA fila de comisión
-- (SELECT INTO), pero el split de sábados (257/260) genera VARIAS filas por
-- despacho y la fila del designado quedaba sin escalar en devoluciones.
-- Restaura el bucle multi-fila de 257 conservando el reembolso atómico y
-- el destino_saldo de 262. Firma idéntica (5 args), idempotente.
