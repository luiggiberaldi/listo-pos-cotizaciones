-- 266_staging_tz_caracas_comisiones.sql
-- Fix TZ: el servidor vive en UTC; Venezuela es UTC-4. Sin este patch, una venta
-- de sábado después de las 8:00 PM (VE) cae en domingo UTC y no splittea (y una
-- de viernes después de 8 PM splitteaba). Alinea dow/fecha de designación a
-- America/Caracas. Espejo del fix aplicado al principal el 2026-09-05 (release 07).
