...
export default {
  async fetch(request, env) {
    ...
    // ── API: corregir fecha efectiva de entrega (staging: roles explícitos) ───
    if (url.pathname === '/api/despachos/cambiar-fecha-entrega' && request.method === 'POST') {
      return handleCambiarFechaEntregaDespacho(request, env);
    }
...
// Hot-reload trigger: fixed syntax in despachos.js
